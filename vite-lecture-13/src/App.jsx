// ye kam useReducer,Custom Hook,ka ha

// import React from 'react'
// import "./App.css"
// import useOnlineStatus from './CustomHook/OnlinestatusCheck'
// import Users from './CustomHook/Users'
// import Products from './CustomHook/Products'
// import LearnRducer from './LearnRducer'
...
const LazyComponent = lazy(() => new Promise(resolve => {
    setTimeout(() => {
      resolve(import("./CustomHook/Lazy"))    ///==setTimeout lgaya ha laga skeleton show ho sakty
    }, 1000)
  })
)
const App = () => {
